...
async function addFriend(){
  ...
  if(friendCode.value.trim() === myCode.value){
    showMessage('No puedes agregarte a ti mismo', 'error')
    return
  }
  ...
  try{
    ...
    friendCode.value = ''
    showMessage('✓ Amigo agregado correctamente', 'success')
  }catch(e){
    showMessage('✗ No se encontró usuario con ese código', 'error')
  }finally{
    adding.value = false
  }
}
        ...
        <div class="friends-grid">
          ...
          >
            ...
            <div class="friend-actions">
              <button @click="router.push(`/battle?friend=${friend.code}`)">
                ⚔️ Batalla
              </button>
            </div>
          </div>
